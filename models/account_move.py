...
class AccountMove(models.Model):
    ...
    def get_token(key, secret, version, env_type):
        ...
        if env_type == "Pre Production":
            loginurl = "id.preprod.eta.gov.eg"
        else:
    ...
    #                     sum_t1 = sum_t1 + round((rec.price_subtotal * tax.amount/100), 5)
    #                 elif tax.eta_tax_type == "T4":
    #                     sum_t4 = sum_t4 + round((rec.price_subtotal * tax.amount/100), 5)
    #
